 ...
 * @author Smit
 */
@WebServlet(name = "RegistrarVentaEmpleado", urlPatterns = {"/RegistrarVentaEmpleado"})
public class RegistrarVentaEmpleado extends HttpServlet {
        ...
        if (ventaDAO.registrarVenta(venta)) {
            ...
            try (OutputStream out = response.getOutputStream()) {
                ...
                try (Document document = new Document(pdf)) {
                    ...
                    document.add(new Paragraph("------------------------------------------------"));
                    document.add(new Paragraph(String.format("Total a pagar: S/ %.2f", total)).setFont(boldFont).setTextAlignment(TextAlignment.RIGHT));
            ...
            request.getRequestDispatcher("ListarVentaEmpleado").forward(request, response);
        }
